...
(1, 'Torta de chocolate', 'Bizcocho esponjoso cubierto cuidadosamente con una capa de chocolate negro y una frambuesa en el centro.', 37.80, '../assets/img/postres/torta_de_chocolate.jpg', 1),
(2, 'Cheesecake de Frutos Rojos', 'Una base de galleta crocante que sostiene una cremosa mezcla de queso, coronada con una capa generosa de mermelada de frutos rojos naturales: frambuesas, fresas y arándanos.', 43.70, '../assets/img/postres/cheesecake_de_frutos_rojos.jpg', 1),
(3, 'Tiramisú Clásico Italiano', 'Bizcochos empapados en café espresso, entre capas de crema de mascarpone sedosa, espolvoreado con cacao puro para un final sofisticado. 2 por unidad', 9.50, '../assets/img/postres/tiramisu_clasico_italiano.jpg', 6),
(4, 'Flan Casero con Caramelo', 'Textura suave y delicada, con un brillante caramelo líquido que aporta dulzura y un sabor nostálgico a cada bocado.', 5.20, '../assets/img/postres/flan_casero_con_caramelo.jpg', 7),
(5, 'Brownie de Chocolate Amargo con Nueces', 'Denso, húmedo y con un intenso sabor a chocolate, con nueces tostadas que aportan un contraste crujiente irresistible.', 15.30, '../assets/img/postres/brownie_de_chocolate_amargo_con_nueces.jpg', 6),
(6, 'Pastel Tres Leches Tradicional', ' Un bizcocho esponjoso bañado en leche condensada, evaporada y crema de leche, cubierto con merengue dorado y un toque de canela', 42.50, '../assets/img/postres/pastel_de_tres_leches_tradicional.jpg', 1),
(7, 'Mousse de Maracuyá con Base Crocante', 'Postre aireado con el sabor exótico y ligeramente ácido del maracuyá, servido sobre una base de galleta triturada.', 41.20, '../assets/img/postres/mousse_de_maracuya.jpg', 7),
(8, 'Tarta de Manzana Casera', 'Manzanas caramelizadas al horno sobre masa hojaldrada, aromatizadas con canela y nuez moscada.', 36.20, '../assets/img/postres/tarta_manzana_casera.jpg', 1),
(9, 'Cupcake Red Velvet con Crema de Queso', 'Suave pastel rojo con glaseado de queso crema batido, decorado con migas de red velvet. 6 por unidad', 15.10, '../assets/img/postres/cupcake_red_velvet_con_crema_de_queso.jpg', 4),
(10, 'Profiteroles Rellenos de Crema Pastelera', 'Delicadas bolas de masa choux rellenas de crema de vainilla, bañadas en chocolate negro. 6 por unidad ', 12.60, '../assets/img/postres/profiteroles_rellenos_de_crema_pastelera.jpg', 6),
(11, 'Gelatina Tricolor de Sabores Frutales', 'Tres capas coloridas con sabores de uva, piña y fresa, perfectamente definidas y refrescantes.', 23.50, '../assets/img/postres/gelatina_tricolor_de_sabores_frutales.jpg', 7),
(12, 'Arroz con Leche Cremoso a la Canela', 'Arroz tierno cocinado con leche, azúcar, canela y ralladura de naranja.', 4.10, '../assets/img/postres/arroz_con_leche_cremoso_a_la_canela.jpg', 6),
(13, 'Pastel de Zanahoria con Nueces y Glaseado', 'Bizcocho húmedo con zanahoria rallada y nueces, cubierto con glaseado de queso crema.', 48.80, '../assets/img/postres/pastel_de_zanahoria_con_nueces_y_glaseado.jpg', 1),
(14, 'Helado Artesanal de Fresa Natural', 'Helado hecho con fresas frescas, sin colorantes, con textura suave y sabor auténtico.', 6.30, '../assets/img/postres/helado_artesanal_de_fresa_natural.jpg', 2),
(15, 'Pastel de Chocolate Intenso con Ganache', 'Bizcocho oscuro con cobertura espesa de ganache de chocolate derretido.', 58.20, '../assets/img/postres/pastel_de_chocolate_intenso_con_ganeche.jpg', 1),
(16, 'Pay de Limón con Merengue Tostado', 'Relleno de limón sobre base de galleta, cubierto con merengue dorado al horno.', 36.50, '../assets/img/postres/pay_de_limon_con_merengue_tostado.jpg', 6),
(17, 'Mousse de Chocolate Negro', 'Espuma de chocolate aireada, decorada con ralladura de chocolate y menta fresca. ', 4.50, '../assets/img/postres/mousse_chocolate_negro.jpg', 7),
(18, 'Pannacotta de Coco con Salsa Tropical', 'Suave postre italiano con leche de coco y reducción de piña y mango.', 6.40, '../assets/img/postres/pannacotta_de_coco_con_salsa_tropical.jpeg', 7),
(19, 'Pastel Selva Negra Clásico', 'Capas de bizcocho de chocolate, cerezas maceradas y crema batida, con virutas de chocolate.', 52.50, '../assets/img/postres/pastel_selva_negra_clasico.jpg', 1),
(20, 'Bavarois de Mango Tropical', 'Postre frío y ligero con mango fresco y nata, ideal como postre refrescante.', 20.20, '../assets/img/postres/bavarois_de_mango_tropical.jpg', 7),
(21, 'Donas Glaseadas Artesanales', 'Donas esponjosas con glaseado dulce de vainilla o chocolate. 6 por unidad', 14.60, '../assets/img/postres/donas_glaseadas_artesanales.jpg', 6),
(22, 'Pastel de Oreo con Crema de Vainilla', 'Capas de crema batida con galleta Oreo y base crocante de chocolate.', 50.20, '../assets/img/postres/pastel_de_oreo_con_crema_de_vainilla.jpg', 1),
(23, 'Crema Volteada Casera', 'Similar al flan, con textura firme, cubierta con caramelo espeso.', 34.40, '../assets/img/postres/Crema_Volteada_Casera.jpg', 7),
(24, 'Rollitos de Canela recién horneados', 'Masa tierna enrollada con canela y azúcar moreno, glaseada con vainilla. 6 por unidad', 11.40, '../assets/img/postres/rollitos_de_canela.jpg', 6),
(25, 'Napoleón de Fresas y Crema Pastelera', 'Capas de hojaldre rellenas con crema pastelera y fresas frescas.', 21.10, '../assets/img/postres/napoleon_de_fresas_y_crema_pastelera.jpg', 6),
(26, 'Pastel de Limón y Arándanos', 'Bizcocho con arándanos frescos y glaseado de limón natural.', 48.90, '../assets/img/postres/pastel_de_limon_y_arandanos.jpeg', 1),
(27, 'Trufas de Chocolate con Relleno Cremoso', 'Bombones redondos con centro suave de ganache y cobertura de cacao. 6 por unidad', 10.20, '../assets/img/postres/trufas_de_chocolate_con_relleno.jpg', 6),
(28, 'Tarta de Queso al Horno estilo Nueva York', 'Cremosa, firme y dorada, servida con salsa de frutos rojos.', 48.20, '../assets/img/postres/tarta_de_queso_estilo_nueva_york.jpg', 1),
(29, 'Parfait de Yogur Griego y Frutas', 'Capas frescas de yogur cremoso, granola tostada con miel y frutas naturales como kiwi, fresas y arándanos', 6.10, '../assets/img/postres/parfait_de_yogur_griego_y_frutas.jpg', 7),
(30, 'Helado de Maracuyá con Chips de Chocolate', 'Helado tropical con toque ácido y trozos crujientes de chocolate.', 7.30, '../assets/img/postres/helado_de_maracuya_con_chips_de_chocolate.jpg', 2),
(31, 'Torta de Plátano y Nuez Caramelizada', 'Bizcocho húmedo de plátano con nueces tostadas y glaseado de caramelo caliente', 55.60, '../assets/img/postres/torta_de_platano_y_nuez_caramelizada.jpg', 1),
...
(78, 'Cupcake de Chocolate y Menta', 'Fresco con toque de menta', 19.50, 'assets/img/cupcakes/cupcake_de_chocolate_y_menta.jpg', 4),
...
(88, 'Cupcake de Nutella', 'Cremoso con avellanas', 22.00, 'assets/img/cupcakes/cupcake_de_nutella.jpg', 4),
...
(91, 'Cupcake de Canela', 'Aromático con glaseado', 18.70, 'assets/img/cupcakes/cupcake_de_canela.jpg', 4),
...
(96, 'Quiche de Champiñones', 'Cremosa con champiñones frescos', 22.00, 'assets/img/postres_salados/quiche_de_champinones.jpg', 5),
...
(101, 'Tarta de Espárragos', 'Fresca con espárragos tiernos', 23.10, 'assets/img/postres_salados/tarta_de_esparragos.jpg', 5),
(102, 'Empanada de Verduras', 'Rellena de vegetales mixtos', 20.50, 'assets/img/postres_salados/empanada_de_verduras.jpg', 5),
...
(107, 'Flan de Café', 'Suave con un toque de café', 16.50, 'assets/img/postres_dulces_o_frios/flan_de_cafe.jpg', 6),
(108, 'Gelatina de Frutas Mixtas', 'Colorida con frutas frescas', 14.80, 'assets/img/postres_dulces_o_frios/gelatina_de_frutas_mixtas.jpg', 6),
(109, 'Arroz con Leche de Coco', 'Cremoso con coco rallado', 17.20, 'assets/img/postres_dulces_o_frios/arroz_con_leche_de_coco.jpg', 6),
(110, 'Pudín de Pan y Canela', 'Tradicional con pan y especias', 15.90, 'assets/img/postres_dulces_o_frios/pudin_de_pan_y_canela.jpg', 6),
(111, 'Semifreddo de Chocolate', 'Fresco y con chocolate oscuro', 18.30, 'assets/img/postres_dulces_o_frios/semifreddo_de_chocolate.jpg', 6),
(112, 'Mousse de Limón', 'Ligero y cítrico', 16.70, 'assets/img/postres_dulces_o_frios/mousse_de_limon.jpg', 6),
(113, 'Panna Cotta de Vainilla', 'Suave con salsa de frutos rojos', 17.60, 'assets/img/postres_dulces_o_frios/panna_cotta_de_vainilla.jpg', 6),
(114, 'Terrina de Frutas', 'Fresca con capas de frutas', 15.40, 'assets/img/postres_dulces_o_frios/terrina_de_frutas.jpg', 6),
(115, 'Parfait de Yogur', 'Cremoso con frutas y granola', 18.00, 'assets/img/postres_dulces_o_frios/parfait_de_yogur.jpg', 6),
(116, 'Sorbete de Mango', 'Refrescante y natural', 16.20, 'assets/img/postres_dulces_o_frios/sorbete_de_mango.jpg', 6),
(117, 'Crema Catalana', 'Clásica con crujiente de azúcar', 17.90, 'assets/img/postres_dulces_o_frios/crema_catalana.jpg', 6),
(118, 'Gelatina de Vino Tinto', 'Elegante con notas de vino', 15.70, 'assets/img/postres_dulces_o_frios/gelatina_de_vino_tinto.jpg', 6),
(119, 'Pudín de Chocolate', 'Intenso y cremoso', 18.50, 'assets/img/postres_dulces_o_frios/pudin_de_chocolate.jpg', 6),
(120, 'Mousse de Frambuesa', 'Ligero con frambuesas frescas', 17.30, 'assets/img/postres_dulces_o_frios/mousse_de_frambuesa.jpg', 6),
(121, 'Semifreddo de Avellana', 'Dulce con avellanas tostadas', 19.10, 'assets/img/postres_dulces_o_frios/semifreddo_de_avellana.jpg', 6),
...
(126, 'Mousse de Mango', 'Tropical y refrescante', 20.90, 'assets/img/postres_de_crema_o_frios/mousse_de_mango.jpg', 7),
(127, 'Panna Cotta de Fresa', 'Con salsa de fresas frescas', 22.70, 'assets/img/postres_de_crema_o_frios/panna_cotta_de_fresa.jpg', 7),
(128, 'Crema de Café', 'Aromática con toque de canela', 21.30, 'assets/img/postres_de_crema_o_frios/crema_de_cafe.jpg', 7),
(129, 'Mousse de Avellana', 'Cremosa con avellanas', 23.20, 'assets/img/postres_de_crema_o_frios/mousse_de_avellana.jpg', 7),
(130, 'Panna Cotta de Pistacho', 'Exótica con pistacho', 22.60, 'assets/img/postres_de_crema_o_frios/panna_cotta_de_pistacho.jpg', 7),
(131, 'Crema de Limón', 'Cítrica y ligera', 20.70, 'assets/img/postres_de_crema_o_frios/crema_de_limon.jpg', 7),
(132, 'Mousse de Chocolate Negro', 'Intenso y aterciopelado', 24.00, 'assets/img/postres_de_crema_o_frios/mousse_de_chocolate_negro.jpg', 7),
(133, 'Panna Cotta de Baileys', 'Con un toque de licor', 23.90, 'assets/img/postres_de_crema_o_frios/panna_cotta_de_baileys.jpg', 7),
(134, 'Crema de Vainilla', 'Clásica con notas suaves', 21.50, 'assets/img/postres_de_crema_o_frios/crema_de_vainilla.jpg', 7),
(135, 'Mousse de Frutas del Bosque', 'Fresca con frutos mixtos', 22.30, 'assets/img/postres_de_crema_o_frios/mousse_de_frutas_del_bosque.jpg', 7),
